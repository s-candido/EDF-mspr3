"""
Per-region consumption prediction pipeline.
...
Usage:
    from pipelines.prediction_consommation_regions import (
        run_pipeline_prediction_consomation_regions,
    )
    run_pipeline_prediction_consomation_regions()
"""
...
def run_pipeline_prediction_consomation_regions(
    ...
    Args:
        ...
        feature_columns: Feature columns for training/prediction.
        regions: Subset of regions to process (None = all).
        rebuild_features: Drop and recreate feature tables.
        skip_training: Skip model training phase.
        skip_prediction: Skip batch prediction phase.
        selected_years: Filter predictions by year(s).
        selected_months: Filter predictions by month(s).
        selected_days: Filter predictions by day(s).

    Returns:
        Dict with pipeline results per phase.
    """
    print("=" * 60)
