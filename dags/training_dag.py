...
from src.mlflow.mlflow_utils import create_experiment_and_start_run
...
def train_and_log_model(**context):
    ...
    experiment_id, active_run = create_experiment_and_start_run(
        experiment_name, f"training_{best_name}_{timestamp}", MLFLOW_URL
    )
